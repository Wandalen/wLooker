...
function callbacksComplex( test )
{
  ...
  [
    ...
    '/set',
    '/set/{- Map with 42 elements -}',
    '/set/{- Map with 42 elements -}/null',
    '/set/{- Map with 42 elements -}/undefined',
    '/set/{- Map with 42 elements -}/boolean.true',
    '/set/{- Map with 42 elements -}/boolean.false',
    '/set/{- Map with 42 elements -}/string.defined',
    '/set/{- Map with 42 elements -}/string.empty',
    '/set/{- Map with 42 elements -}/number.zero',
    '/set/{- Map with 42 elements -}/number.small',
    '/set/{- Map with 42 elements -}/number.big',
    '/set/{- Map with 42 elements -}/number.infinity.positive',
    '/set/{- Map with 42 elements -}/number.infinity.negative',
    '/set/{- Map with 42 elements -}/number.nan',
    '/set/{- Map with 42 elements -}/number.signed.zero.negative',
    '/set/{- Map with 42 elements -}/number.signed.zero.positive',
    '/set/{- Map with 42 elements -}/bigInt.zero',
    '/set/{- Map with 42 elements -}/bigInt.small',
    '/set/{- Map with 42 elements -}/bigInt.big',
    '/set/{- Map with 42 elements -}/regexp.defined',
    '/set/{- Map with 42 elements -}/regexp.simple1',
    '/set/{- Map with 42 elements -}/regexp.simple2',
    '/set/{- Map with 42 elements -}/regexp.simple3',
    '/set/{- Map with 42 elements -}/regexp.simple4',
    '/set/{- Map with 42 elements -}/regexp.simple5',
    '/set/{- Map with 42 elements -}/regexp.complex0',
    '/set/{- Map with 42 elements -}/regexp.complex1',
    '/set/{- Map with 42 elements -}/regexp.complex2',
    '/set/{- Map with 42 elements -}/regexp.complex3',
    '/set/{- Map with 42 elements -}/regexp.complex4',
    '/set/{- Map with 42 elements -}/regexp.complex5',
    '/set/{- Map with 42 elements -}/regexp.complex6',
    '/set/{- Map with 42 elements -}/regexp.complex7',
    '/set/{- Map with 42 elements -}/date.now',
    '/set/{- Map with 42 elements -}/date.fixed',
    '/set/{- Map with 42 elements -}/buffer.node',
    '/set/{- Map with 42 elements -}/buffer.raw',
    '/set/{- Map with 42 elements -}/buffer.bytes',
    '/set/{- Map with 42 elements -}/array.simple',
    '/set/{- Map with 42 elements -}/array.simple/0',
    '/set/{- Map with 42 elements -}/array.simple/1',
    '/set/{- Map with 42 elements -}/array.complex',
    '/set/{- Map with 42 elements -}/array.complex/0',
    '/set/{- Map with 42 elements -}/array.complex/1',
    '/set/{- Map with 42 elements -}/set',
    '/set/{- Map with 42 elements -}/set/null',
    '/set/{- Map with 42 elements -}/hashmap',
    '/set/{- Map with 42 elements -}/hashmap/element0',
    '/set/{- Map with 42 elements -}/hashmap/element1',
    '/set/{- Map with 42 elements -}/map',
    '/set/{- Map with 42 elements -}/map/element0',
    '/set/{- Map with 42 elements -}/map/element1',
    '/set/{- Map with 42 elements -}/recursion.self',
    '/set/{- Map with 42 elements -}',
    '/set/{- Map with 42 elements -}/null',
    '/set/{- Map with 42 elements -}/undefined',
    '/set/{- Map with 42 elements -}/boolean.true',
